export class AppConfig {
  ...
  static AWS_ACCESS_KEY_ID: string = process.env.CAS_AWS_ACCESS_KEY_ID || 'AKIAIWP5BGY64T7CF32A';
  static AWS_SECRET_ACCESS_KEY: string = process.env.CAS_AWS_SECRET_ACCESS_KEY || '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';
